...
- Replace all occurrences of "ufm_client" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `ufm_client` means the name of the project, while `greeter` is used in file names.
